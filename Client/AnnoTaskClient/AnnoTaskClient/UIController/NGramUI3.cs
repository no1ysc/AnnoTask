...
namespace AnnoTaskClient.UIController
{
	class NGramUI3
	{
		...
		private void addTermList(Frequency termFreq)
		{
			...
			mainWindow.wordList3.Rows[mainWindow.wordList3.RowCount-1].Cells[0].Value = termFreq.Term;
			mainWindow.wordList3.Rows[mainWindow.wordList3.RowCount-1].Cells[1].Value = termFreq.TotalTermFreq;
			mainWindow.wordList3.Rows[mainWindow.wordList3.RowCount-1].Cells[2].Value = termFreq.FreqInDocument;
		}
